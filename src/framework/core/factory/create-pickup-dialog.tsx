...
>(
  ...
  const resolvedFeatures = dataView?.pickup?.features
    ? resolveFeatures(dataView.pickup.features)
    : undefined;

  return memo(function PickupDialog({
    open,
    setOpen,
    onSelect,
    preFilters = [],
      ...
      >
        ...
        <div className="flex min-h-0 w-full flex-1 flex-col px-4">
          <DataView
            ...
            initialListColumnVisibility={pickupListColumnVisibility}
            data={allItems}
