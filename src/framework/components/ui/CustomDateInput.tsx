...
import { CustomCalendar } from "@/framework/components/ui/CustomCalendar";
...
> {
  ...
  hasError?: boolean;
  calendarProps?: Omit<
    React.ComponentProps<typeof CustomCalendar>,
    "mode" | "selected" | "onSelect"
  >;
}

const CustomDateInput = React.forwardRef<HTMLInputElement, DateInputProps>(
  (
    {
      value,
      onChange,
